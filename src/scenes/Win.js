...
class WinScreen extends IScene {
    text =  <div>
        <h3>You win!</h3>
        <p>
            Thanks for playing! We hope you enjoyed learning about how privacy 
            impacts people in their day-to-day lives and about the laws/rights 
            that citizens have in regards to privacy!
        </p>
    </div>;
    btns = [];
}
